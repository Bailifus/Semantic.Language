...
отношения. Реализация не должна требовать отдельный Predicate как нормативный
носитель семантики; внутреннее представление, аналогичное Predicate, если оно
используется, не создаёт самостоятельного семантического элемента Core.
...
Каждая Entity, каждый Statement, каждая Role и каждый Statement Instance должны
иметь уникальный и устойчивый полный HIP в пределах Semantic Model. Внутренние
